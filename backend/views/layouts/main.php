...
use backend\assets\DashboardAssest;
...
<header class="main-header">
	  ...
	  <aside class="main-sidebar">
		...
		<li class="active treeview">
              <a href="index.php?r=site/login">
                <i class="fa fa-dashboard"></i> <span>Login</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
	...
	<li class="active treeview">
              <a href="index.php?r=site/logout">
                <i class="fa fa-dashboard"></i> <span>Logout ( <?php echo Yii::$app->user->identity->username; ?>)</span> <i class="fa fa-angle-left pull-right"></i>
              </a>
